...
const createSuperAdminSchemaValidation = z.object({
    body:z.object({
...
const updateSuperAdminSchemaValidation = z.object({
    body:z.object({
        user: z.string().min(1, 'User ID is required').optional(), 
...
export const SuperAdminValidation = {
  createSuperAdminSchemaValidation,updateSuperAdminSchemaValidation
};
